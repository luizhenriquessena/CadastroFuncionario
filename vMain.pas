...
begin
  // Habilitar a seleção da linha ao clicar na célula.
...
begin
  // Mudar a cor da linha quando o funcionário estiver cancelado.
  ...
  // Manter cor de seleção mesmo se sair do GRID.
