object DM: TDM
  ...
  object qryGridFunc: TADOQuery
    ...
    SQL.Strings = (
        ...
        ' select f.idFuncionario, f.nomeFuncionario, f.sexo, f.cancelado ' +
        'situacao,'
      '       case f.cancelado'
      ...
      #9'   end situacaoDesc,'
        ...
        'o, b.bairro, f.dataCriacao, f.nascimento'
      '  from funcionario f'
      ...
      #9'   or'
      #9'  f.idFuncionario = :varID'
      ' order by situacao, nomeFuncionario')
    Left = 24
    Top = 88
    ...
    object qryGridFuncsituacaoDesc: TStringField
      FieldName = 'situacaoDesc'
      ReadOnly = True
      Size = 9
    end
    object qryGridFuncnascimento: TDateField
