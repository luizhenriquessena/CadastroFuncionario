...
function ApenasNumeros(vValor:String):Integer; // Função para deixar apenas o numeros
...
function ApenasLetras(vValor:String):String; // Função para deixar apenas as letras
var i : Integer;
begin
  vTXT1 := '';
